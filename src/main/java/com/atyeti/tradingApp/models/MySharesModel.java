...
public class MySharesModel {
    ...
    public MySharesModel(int company_id, String name, String user_id, int open_rate, int close_rate, int peak_rate,
                         int least_rate, int current_rate, int quantity, int bought_rate, int year_low, int year_high,
                         float market_cap, float p_e_ratio, int volume, String date, String time) {
        super();
        this.company_id = company_id;
        this.name = name;
        this.user_id = user_id;
